...
BuildApp:
		...
		python3 -m PyInstaller --icon=icons/icon-256x256.png -F --noconfirm --add-data="icons/icon-256x256.png":"./icons/"   --add-binary="ffmpeg-6.0-amd64-static/ffmpeg:." --add-binary="/usr/bin/curl:."    GUIPortable.py
